...
class NotesOptions {
  ...
  static NotesOptions of(BuildContext context) {
    final scope =
    context.dependOnInheritedWidgetOfExactType<_ModelBindingScope>();
    return scope.modelBindingState.currentModel;
  }

  static void update(BuildContext context, NotesOptions newModel) {
    final scope =
    context.dependOnInheritedWidgetOfExactType<_ModelBindingScope>();
...
class ApplyTextOptions extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final options = NotesOptions.of(context);
...
class ModelBinding extends StatefulWidget {
  ModelBinding({
    Key key,
    this.initialModel = const NotesOptions(),
    this.child,
  })  : assert(initialModel != null),
        super(key: key);

  final NotesOptions initialModel;
  final Widget child;
...
class _ModelBindingState extends State<ModelBinding> {
  ...
  void handleTimeDilation(NotesOptions newModel) {
  ...
  void updateModel(NotesOptions newModel) {
